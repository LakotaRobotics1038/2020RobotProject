...
public class GalacticCommands extends Auton{
    ...
    public GalacticCommands() {
        ...
        switch(teamColor) {
            ...
            final int SECOND_DRIVE_DIST_BLUE = 99.36;
            final int THIRD_DRIVE_DIST_BLUE = 67.08;
            final int FOURTH_DRIVE_DIST_BLUE = 60;
            final int ACQUIRE_TIME_BLUE = 2;
            final int FIRST_TURN_ANGLE_BLUE = -63.438;
            final int SECOND_TURN_ANGLE_BLUE = 63.367;
            ...
            final int SECOND_DRIVE_DIST_RED = 67.08;
            final int THIRD_DRIVE_DIST_RED = 99.36
            final int FOURTH_DRIVE_DIST_RED = 156
            final int ACQUIRE_TIME_RED = 2;
            final int FIRST_TURN_ANGLE_RED = 63.367;
            final int SECOND_TURN_ANGLE_RED = -63.438;
